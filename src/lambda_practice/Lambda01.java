...
public class Lambda01 {
   ...
   */
    public static int elToplam(List<Integer>l){
        ...
        /*
        * x ilk degerini her zaman atanan degerden (ilk parametre) alır,
        bu örnekte 0 oluyor
        * y degerini her zamana  stream()'dan akısdan alır
        * x ilk degerinden sonraki her değeri action(işlem)'dan alır */
