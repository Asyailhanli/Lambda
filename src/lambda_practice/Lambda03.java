...
public class Lambda03 {
    ...
    public static void doguKirayaSirala(List<Apartman> list){
        list.stream().
                filter(t->t.getCephe().equalsIgnoreCase("dogu")). //cephesi dogu olan dairelerin filtreledim
    ...
    public static List<Integer> kat2denCokKiraList(List<Apartman> list){
       return list.stream().
               ...
               map(t->t.getKira()).collect(Collectors.toList());//apartmani kiraya ceviridigimiz icin filter degilde map kullandik
    }
}
